...
export const EventCard = ({
	...
	return (
		<>
			<div className="flex flex-col items-center justify-center bg-white dark:bg-[#333333] shadow-lg rounded-lg p-4 m-4 w-90">
				<img
					src={data.image}
					alt={data.title}
					className="28 rounded-lg w-full h-48 object-cover"
				/>
...
const data = [
	{
		...
		image: "https://img.evbuc.com/https%3A%2F%2Fcdn.evbuc.com%2Fimages%2F973376063%2F94967186259%2F1%2Foriginal.20250303-041905?w=512&auto=format%2Ccompress&q=75&sharp=10&rect=0%2C0%2C2160%2C1080&s=c0833cd98c66a98f4e200c235cb4b98a",
		source: "Eventbrite",
